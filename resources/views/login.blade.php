        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            <div class="login-brand">
             ...
             <div class="text-center" style="color: #6777ef"><h6>PT. Mahakarya Tata Alam</h6></div><br><br>
                          @if (session('success'))
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                <form action="{{route('login-proses')}}" method="post">
                  ...
                  <input type="username" class="form-control" tabindex="1" required="" name="username" placeholder="username"><br>
