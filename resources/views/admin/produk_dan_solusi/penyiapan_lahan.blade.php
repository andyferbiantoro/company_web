          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Tambah Penyiapan Lahan</h5>
              ...
              <div class="modal-body">
               <form method="post" action="{{route('admin_produk_dan_solusi_add')}}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  <input type="hidden" class="form-control" id="jenis" name="jenis" value="4" />
                </div>
