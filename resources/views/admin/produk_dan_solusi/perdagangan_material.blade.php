 ...
 <div class="col-lg-12">
  <div class="card">
                <div class="card-header">
                  <h4>Perdagangan Besar Berbagai Macam Material Bangunan</h4>
                </div>
                <div class="card-body">
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Tambah Perdagangan Besar Berbagai Macam Material Bangunan</h5>
              ...
              <div class="modal-body">
               <form method="post" action="{{route('admin_produk_dan_solusi_add')}}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  <input type="hidden" class="form-control" id="jenis" name="jenis" value="5" />
                </div>
